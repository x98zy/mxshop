...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_sn', models.CharField(max_length=40, verbose_name='订单编号')),
                ('trade_no', models.CharField(max_length=40, verbose_name='交易编号')),
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancel', '取消'), ('waiting', '待支付')], max_length=30, verbose_name='支付状态')),
                ...
                ('address', models.CharField(default='', max_length=30, verbose_name='收获地址')),
                ('signer_name', models.CharField(max_length=30, verbose_name='签收人')),
                ('signer_mobile', models.CharField(max_length=30, verbose_name='联系电话')),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '订单',
